...
export function CreateAdModal() {
    ...
    async function handleGameCreateAd(event: FormEvent) {
        ...
        try {
            await axios.post(`http://localhost:5555/games/${data.game}/ads`, {
                name: data.name,
        ...
        <Dialog.Portal>
            ...
            <Dialog.Overlay className='bg-black/60 inset-0 fixed' >
                <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-black/25'>
                    ...
                    <form onSubmit={handleGameCreateAd} className='mt-8 flex flex-col gap-4'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <select
                                ...
                                defaultValue=''
                            >
                                <option className="text-zinc-500 " value='' disabled >Selecione o game que deseja jogar</option>
                        ...
                        <div className='flex flex-col'>
                            <label htmlFor="game">Seu nome (ou seu nickname)?</label>
                            <Input
                                name="name"
                                id='name'
                                type="text"
